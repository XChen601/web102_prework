...
const displayStr = unfundedGames.length === 1 ? "game" : "games";

// create a new DOM element containing the template string and append it to the description container
const unfundedGamesStr = document.createElement("p");
unfundedGamesStr.innerHTML = `
    There are currently ${unfundedGames.length} ${displayStr} that still need funding.
`;
descriptionContainer.appendChild(unfundedGamesStr);
